...
<head>
    ...
    <style>
        ...
        /* Estilos del contenido emergente (Popup) */
        .popup-fecha {
            color: #e67e22;
            font-weight: bold;
            font-size: 1.1em;
...
/* DISEÑO ADAPTABLE PARA CELULARES Y COMPUTADORAS */
        @media screen and (max-width: 768px) {
            ...
            #mi-mapa {
                height: 380px; /* Mapa más compacto en celulares */
                border-radius: 5px;
            }
            #trivia-container {
                padding: 12px;
            ...
            .opciones label {
                padding: 12px; /* Mayor área táctil para los dedos */
                font-size: 0.9em;
            }
        }
    </style>
...
<body>
    ...
    <div id="trivia-container">
        ...
        <p style="text-align:center; color:#7f8c8d; margin-bottom: 20px;">Pon a prueba tus conocimientos sobre la lectura.</p>
        <div id="quiz"></div>
        <button onclick="calificarTrivia()">Calificar mis respuestas</button>
    ...
    <script>
        ...
        eventos.forEach(function(evento, index) {
            ...
            // Ícono personalizado (Círculo con número)
            ...
            // Contenido del Popup con Fecha y Texto Extendido
            var contenidoPopup = `
                <div style="width: 250px;">
                    <div class="popup-fecha">⏳ ${evento.fecha}</div>
                    <h3 style="margin: 5px 0; color: #2c3e50;">${numero}. ${evento.titulo}</h3>
        ...
        // Generar preguntas de la trivia
